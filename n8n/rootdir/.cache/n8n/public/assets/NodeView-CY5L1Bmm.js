const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreation-BR_PsZYm.js","assets/index-CN4JmOoA.js","assets/index-DwKuVkBg.css","assets/useCanvasOperations-BW3qnkOc.js","assets/NodeCreation-RKvezEeg.css","assets/NodeDetailsView-Ao8qCvow.js","assets/import-curl-DVtpAPDa.js","assets/FileSaver.min-DbOfV2ME.js","assets/RunDataAi-DsidSvp-.js","assets/useExecutionHelpers-Bet0YWvb.js","assets/dateFormatter-DP26ifk_.js","assets/RunDataAi-CUUDqZRP.css","assets/useWorkflowActivate-BZzKuzDM.js","assets/NodeDetailsView-B2kdGJ7R.css","assets/SetupWorkflowCredentialsButton-BNGDx7Fp.js"])))=>i.map(i=>d[i]);
import { d as defineComponent, h as resolveComponent, e as createBlock, g as openBlock, C as createEventBus, a0 as useCssModule, bI as toRef, q as computed, r as ref, bJ as refDebounced, i as createElementBlock, k as createBaseVNode, x as renderSlot, f as createCommentVNode, b3 as mergeProps, m as unref, n as normalizeClass, _ as _export_sfc, c as useI18n, bK as KeyboardShortcutTooltip, w as withCtx, j as createVNode, J as withModifiers, bL as reactive, o as onMounted, b7 as onUnmounted, l as createTextVNode, t as toDisplayString, b as useRouter, W as useRoute, a as useToast, a6 as useDocumentTitle, a7 as useWorkflowHelpers, bx as useNodeHelpers, bw as useNodeTypesStore, L as useUIStore, U as useWorkflowsStore, a3 as useSourceControlStore, p as useSettingsStore, bM as useCredentialsStore, bN as useEnvironmentsStore, bO as useExternalSecretsStore, a1 as useRootStore, av as useExecutionsStore, a2 as useCanvasStore, a5 as useNpsSurveyStore, bP as useHistoryStore, a4 as useProjectsStore, u as useUsersStore, E as useTagsStore, T as usePushConnectionStore, au as useNDVStore, aP as useTemplatesStore, by as useRunWorkflow, ba as useClipboard, X as PLACEHOLDER_EMPTY_WORKFLOW_ID, bQ as NEW_WORKFLOW_ID, V as VIEWS, bR as CanvasNodeRenderType, bz as LOGS_PANEL_STATE, bS as START_NODE_TYPE, bT as getNodeViewTab, s as MAIN_HEADER_TABS, ao as VALID_WORKFLOW_IMPORT_URL_REGEX, ak as useMessage, al as MODAL_CONFIRM, bU as jsonParse, a9 as getResourcePermissions, bv as CHAT_TRIGGER_NODE_TYPE, bk as MANUAL_CHAT_TRIGGER_NODE_TYPE, I as watch, bV as onBeforeRouteLeave, aB as onBeforeMount, am as WORKFLOW_SETTINGS_MODAL_KEY, aR as useExternalHooks, bW as onActivated, bX as onDeactivated, y as onBeforeUnmount, bY as Suspense, bZ as defineAsyncComponent, b_ as N8nCallout, aq as __vitePreload, ac as EnterpriseEditionFeature, z as nextTick, ai as useTelemetry, b$ as tryToParseNumber, aj as nodeViewEventBus, bu as NodeConnectionTypes, c0 as isValidNodeConnectionType, c1 as CanvasConnectionMode, c2 as historyBus, aH as sourceControlEventBus, c3 as getNodesWithNormalizedPosition, as as h, c4 as NODE_CREATOR_OPEN_SOURCES, aA as STICKY_NODE_TYPE, c5 as DRAG_EVENT_DATA_KEY } from "./index-CN4JmOoA.js";
import { u as useVueFlow, a as useCanvasMapping, C as Canvas } from "./useCanvasMapping-BrMdYioA.js";
import { g as globalLinkActionsEventBus } from "./global-link-actions-BxV1MUKt.js";
import { a as useNodeCreatorStore, b as useCanvasOperations, c as createCanvasConnectionHandleString } from "./useCanvasOperations-BW3qnkOc.js";
import { u as useExecutionDebugging } from "./useExecutionDebugging-Dy0Nq0u2.js";
import { u as useBeforeUnload } from "./useBeforeUnload-CQDQ2xRD.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyNodeCreation = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreation-BR_PsZYm.js").then((n) => n.N), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const LazyNodeDetailsView = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeDetailsView-Ao8qCvow.js").then((n) => n.N), true ? __vite__mapDeps([5,1,2,6,7,8,3,9,10,11,12,13]) : void 0)
    );
    const LazySetupWorkflowCredentialsButton = defineAsyncComponent(
      async () => await __vitePreload(() => import("./SetupWorkflowCredentialsButton-BNGDx7Fp.js"), true ? __vite__mapDeps([14,1,2]) : void 0)
    );
    const $style = useCssModule();
