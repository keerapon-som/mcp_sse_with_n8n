const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-C4DFiOh8.js","assets/index-CN4JmOoA.js","assets/index-DwKuVkBg.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-DrgwFS0W.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, au as useNDVStore, r as ref, il as useElementSize, q as computed, hz as executionDataToJson, i as createElementBlock, g as openBlock, e as createBlock, j as createVNode, w as withCtx, f as createCommentVNode, m as unref, bZ as defineAsyncComponent, bY as Suspense, ig as TextWithHighlights, n as normalizeClass, ih as MappingPill, hr as Draggable, aq as __vitePreload, v as shorten, ik as getMappedExpression, im as isString, io as nonExistingJsonPath, aR as useExternalHooks, ai as useTelemetry, _ as _export_sfc } from "./index-CN4JmOoA.js";
import { V as VueJsonPretty } from "./NodeDetailsView-Ao8qCvow.js";
import "./import-curl-DVtpAPDa.js";
import "./FileSaver.min-DbOfV2ME.js";
import "./RunDataAi-DsidSvp-.js";
import "./useCanvasOperations-BW3qnkOc.js";
import "./useExecutionHelpers-Bet0YWvb.js";
import "./dateFormatter-DP26ifk_.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-C4DFiOh8.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
